            ...
            <div class="register-small-flex">
                ...
                <div class="peek-half">
                    <div class="peek-group">
                        <a href='/inzerat/{{ $inzerat->UUID }}' title="Zobraziť inzerát"><span><i
                                        class="far fa-eye peek-awesome"></i></span></a>
                        <a href='updateAdv/{{ $inzerat->UUID }}' title="Upraviť inzerát"> <i
                                    class="fas fa-pencil-alt peek peek-awesome"></i></a>
                        <a href='deletep/{{ $inzerat->UUID }}' title="Vymazať inzerát" class="delete-element"><i
                                    class="fas fa-trash peek-awesome"></i></a>
                    </div>
