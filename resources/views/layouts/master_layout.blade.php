    ...
    <div class="upper-footer">
        ...
        <div class="footer-social-container">
            ...
            <div class="round-button-container">
                <a href=""><div class="round-button"><i class="fab fa-facebook-f awesome-social"></i></div></a>
                <a href=""><div class="round-button"><i class="fab fa-instagram awesome-social"></i></div></a>
                <a href=""><div class="round-button"><i class="fab fa-twitter awesome-social"></i></div></a>
                <a href=""><div class="round-button"><i class="fab fa-google-plus-g awesome-social"></i></div></a>
            </div>
        </div>
    </div>
