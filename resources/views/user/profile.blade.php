                                ...
                                <div>
                                    ...
                                    <div class="register-small-flex">
                                        <div class="user-details-container">
                                            <button id="edit-user" class="add-button" title="Upraviť údaje"><i
                                                        class="fas fa-pencil-alt user-edit-awesome"></i></button>
                                            <button id="stop-edit" class="add-button" title="Zrušiť úpravy"
