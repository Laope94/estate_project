    ...
    <div class="content-container">
        ...
        <div class="newest-container">
            ...
            <div class="flex-container">
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'340', 'lokalita'=>'Bratislava IV', 'rozloha'=>'60'])</div>
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'900', 'lokalita'=>'Spišská Nová Ves', 'rozloha'=>'52'])</div>
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'500', 'lokalita'=>'Vrakuňa', 'rozloha'=>'35'])</div>
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'340', 'lokalita'=>'Bratislava IV', 'rozloha'=>'60'])</div>
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'900', 'lokalita'=>'Spišská Nová Ves', 'rozloha'=>'52'])</div>
                <div class="newest-card">@include('inzerat.inzerat_karta', ['cena'=>'500', 'lokalita'=>'Vrakuňa', 'rozloha'=>'35'])</div>
            </div>
